...
public class TakingTurnsQueueTests
{
    ...
    //  Defect(s) Found: People with finite turns were not being removed correctly once their turns reached 0.
    ...
    // Defect(s) Found: Newly added person (George) not correctly placed in queue after initial processing. 
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with infinite turns (0) may have had their turn counters decremented, or were removed by mistake.
    ...
    // Defect(s) Found: No exception was thrown when the queue was empty
